...
- **In progress:** post-release manual smoke testing and integration with the real catalog.
- **Next:** replace demo Yandex Disk links with the real catalog; configure Telegram Mini App URL and bot credentials; configure the chosen production hosting if access beyond the private Sites deployment is required.
...
- **Release:** 2026-09-09 — production build, lint, typecheck and automated tests passed; the static `dist/` output was published as a private Sites deployment.

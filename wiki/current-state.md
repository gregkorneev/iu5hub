...
- **Last significant change:** 2026-09-08 — navigation now exposes four courses (semesters 1–8); the header retains protected horizontal insets at narrow widths, and the footer includes a styled placeholder for the future source Yandex Disk catalog link. The visual theme remains aligned to the official BMSTU palette (#006CDC, #002C5B, #8CC5F4, #E1EFFB), retaining the animated, reduced-motion-safe interface.

...
- **Last significant change:** 2026-09-08 — product renamed to «ИУ5 Архив» across the UI, page metadata, package metadata, and Wiki. The visual theme remains aligned to the official BMSTU palette (#006CDC, #002C5B, #8CC5F4, #E1EFFB), retaining the animated, reduced-motion-safe interface and course-to-semester navigation.

...
- Home Favorites browser coverage verifies the block follows courses and precedes Useful Links, displays the shared saved-item count, opens the existing populated Profile list, and preserves no-scroll home fit on short Telegram viewports.

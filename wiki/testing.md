...
- Home Favorites browser coverage verifies the block follows courses and precedes Useful Links, displays the shared saved-item count, opens the existing populated Profile list, uses visible section gaps on normal-height mobile viewports, and preserves no-scroll home fit on short Telegram viewports.

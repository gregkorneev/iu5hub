...
2026-09-26: Home spacing regression passes in Chromium, mobile Chromium and WebKit at viewports up to 430×932. Full `npm run qa` had 129/132 UI tests pass; the three failures are the existing schedule test expecting `Сейчас` at a real-time-relative lesson fixture crossing local midnight (not affected by Home CSS). All non-UI checks and the Home regression pass.
